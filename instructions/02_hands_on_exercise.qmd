...
Once your first run works, you can draw a different 10% sample by changing the seed number. Use a new output folder so your original results are not overwritten. The **More Analyses → Second 10% Sample** tab on this site shows a reference run using seed 9 — you can compare your results against it.
...
Check `outputs/my_run_seed9/sample_documents.csv` to see which 29 documents were selected, then compare your topic labels against the reference on the [Second 10% Sample](03_sample2_results.qmd) page.

## Optional: Run the Full Collection

Only do this after the 10% sample works. The full run processes all 294 documents and may take several hours. The **More Analyses → Full Collection** tab on this site shows a reference run — you can compare your results against it.
...
The full collection may take hours. Compare your results against the [Full Collection](04_full_results.qmd) page when it finishes.
