...
All nine reference visualizations — with descriptions and interpretation notes — are on the [Simple Explanation](01_simple_explanation.qmd#reading-the-charts) page. Refer to that page to read and understand the charts alongside your own results.

After running your own pipeline, compare what you see in your CSV files against those reference charts.
