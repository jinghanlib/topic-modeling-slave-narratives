...
An additional visualization — topic trends as faceted line charts, one panel per topic — is available in the [GitHub repository](https://github.com/jinghanlib/topic-modeling-slave-narratives) at `outputs/bertopic_sample_nomic_sensitive_lemmatized/metadata_visualizations/topic_prevalence_by_decade.html`. Download or clone the repository to open it.
