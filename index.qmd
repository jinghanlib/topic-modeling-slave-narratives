...
The [More Analyses](instructions/03_sample2_results.qmd) tab in the navigation bar contains two additional runs for comparison:
...
The [Slides](slides.qmd) tab contains presentation slides covering the same content as the Simple Explanation.
